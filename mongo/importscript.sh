...
mongoimport --db='whitepeak_db' --collection='price' --file='/tmp/json/price/price.json' --jsonArray --username='HrigHdofkroJndi' --password='root' --authenticationDatabase=admin
mongoimport --db='whitepeak_db' --collection='price' --file='/tmp/json/price/price_preview.json' --username='HrigHdofkroJndi' --password='root' --authenticationDatabase=admin
